...
{block name='block_social'}
  <div class="block-social col-lg-4 col-md-12 col-sm-12">
    {*IE-11 no soporta la llamada de ficheros externos para SVG Symbol. Aún así, en assets/img se añade el fichero .svg por si se quisiera usar*}
      ...
      {foreach from=$social_links item='social_link'}
        <li>
          <a href="{$social_link.url}" target="_blank">
            <span class="sr-only">{l s='Link open new tab to social' d='Shop.Theme.Global'} {$social_link.class}</span>
            <svg class="social-icon">
              <use xlink:href="#{$social_link.class}"></use>
            </svg>
          </a>
        </li>
      {/foreach}
